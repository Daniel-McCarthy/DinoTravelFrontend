...
const getFlightData = async () => {
    ...
    // CORS issue preventing the actual API call from being made
    // Stub out call and just use copied API call data
    const responseData = await fetch(flightEndpointURL, opts);
...
class FlightList extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: "flightList" }, isDataEmpty ? this.renderNoFlightDataMessage() : this.renderFlightList()));
    }
}
